"""
Django settings for lucky_rice_dev_96542 project.
...
ROOT_URLCONF = 'lucky_rice_dev_96542.urls'
...
WSGI_APPLICATION = 'lucky_rice_dev_96542.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_rice_dev_96542 API",
    "DESCRIPTION": "API documentation for lucky_rice_dev_96542 App",
    "VERSION": "v1",
}
